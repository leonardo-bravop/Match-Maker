...
router.put("/:leagueId/addUser/:userId", userController.verifyToken ,leagueController.addUser);

router.put("/:leagueId/deleteUser/:userId", userController.verifyToken , leagueController.deleteUser);

router.get("/getUsers/:leagueId", leagueController.getUserByLeagueId)

router.delete("/deleteLeague/:id", userController.verifyToken, leagueController.deleteLeague);

router.get("/showLeague/:id", leagueController.findShowLeague);

router.put("/editLeague/:id", userController.verifyToken, leagueController.editLeague);
